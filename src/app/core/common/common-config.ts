...
export const Staff_Management_Sub_Menu = [
  {
    ...
    icon: 'assets/svg/sidebar/staff-list.svg',
  ...
  },
  {
    ...
    icon: 'assets/svg/sidebar/role-list.svg',
  ...
  },
  {
    ...
    icon: 'assets/svg/sidebar/permissions-list.svg',
...
export const Side_Bar: any = [
  ...
  },
  {
    ...
    is_active: 1,
    icon: 'assets/svg/sidebar/staff-management.svg',
